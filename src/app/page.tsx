...
import { ArrowRight, Check, Star, Award, Gift, CreditCard, Users, Shield } from "lucide-react"
...
export default function LandingPage() {
  return (
    <div className="flex flex-col">
      {/* Hero Section */}
      <section id="hero" className="relative h-screen flex items-center overflow-hidden  bg-gradient-to-br from-violet-600 to-purple-700 py-20 text-white md:py-32">
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            <Badge className="mb-4 bg-white/20 text-white hover:bg-white/30">New Rewards Program</Badge>
            <h1 className="mb-6 text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl">
              Earn Rewards <span className="text-violet-200">Before You Gogo</span>
            </h1>
            <p className="mx-auto mb-10 max-w-2xl text-lg text-violet-100 sm:text-xl">
              Join our premium membership program and earn points with every purchase. Redeem for exclusive rewards,
              discounts, and unique experiences.
            </p>
            <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
              <Button size="lg" className="bg-white text-violet-700 hover:bg-violet-100">
                Join Now
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">
              We offer more than just products. Join our community and enjoy these exclusive benefits.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Members receive special pricing and early access to sales.",
              },
              {
                icon: <Star className="h-8 w-8 text-violet-600" />,
                title: "Earn Points Fast",
                description: "Earn 2x points on every purchase with our premium membership.",
              },
              {
                icon: <Gift className="h-8 w-8 text-violet-600" />,
                title: "Amazing Rewards",
                description: "Redeem points for products, experiences, and more.",
              },
              {
                icon: <Shield className="h-8 w-8 text-violet-600" />,
                title: "Member Protection",
                description: "Extended warranties and satisfaction guarantees for members.",
              },
            ].map((benefit, index) => (
              <div key={index} className="flex flex-col items-center text-center">
                <div className="mb-4 rounded-full bg-violet-100 p-3">{benefit.icon}</div>
      ...
      <section id="pricing" className="bg-gray-50 py-20 h-screen flex items-center">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">
              Select the perfect membership tier that fits your lifestyle and budget.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-6xl">
            <div className="grid gap-12 md:grid-cols-2 md:items-center">
              <div>
                <Badge className="mb-4 bg-violet-100 text-violet-800 hover:bg-violet-200">Loyalty Program</Badge>
                <h2 className="mb-6 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                  Earn Points, Unlock Rewards
                </h2>
                <p className="mb-6 text-lg text-gray-600">
                  Our loyalty program rewards you for every purchase. The more you shop, the more you earn. Redeem your
                  points for exclusive products, experiences, and discounts.
                </p>
                ...
                <div className="mb-8 space-y-4">
                  {[
                    {
                      title: "Earn Points",
                      description: "Get points with every purchase based on your membership tier.",
                    },
                    {
                      title: "Track Progress",
                      description: "Monitor your points balance and redemption history in your dashboard.",
                    },
                    {
                      title: "Redeem Rewards",
                      description: "Exchange points for products, gift cards, or exclusive experiences.",
                    },
                  ].map((item, index) => (
                ...
                <Button className="bg-violet-600 text-white hover:bg-violet-700">Join the Rewards Program</Button>
              </div>
              ...
              <div className="relative">
                ...
                <div className="relative overflow-hidden rounded-xl border border-gray-200 bg-white p-6 shadow-lg">
                  <div className="mb-6 flex items-center justify-between">
                    <div>
                      <h3 className="text-xl font-bold text-gray-900">Rewards Dashboard</h3>
                  ...
                  <div className="mb-6 space-y-4">
                    ...
                    {[
                      ...
                      >
                        ...
                        <div className="flex items-center">
                          <span className="mr-2 text-sm text-gray-600">{reward.points}</span>
                          <Button
                            size="sm"
                            variant={reward.available ? "default" : "outline"}
                            className={reward.available ? "bg-violet-600 hover:bg-violet-700" : "text-gray-400"}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mx-auto mb-10 max-w-2xl text-lg text-violet-100">
              Join thousands of satisfied members who are earning points and redeeming amazing rewards every day.
            </p>
            <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
              <Button size="lg" className="bg-white text-violet-700 hover:bg-violet-100">
                Sign Up Now
